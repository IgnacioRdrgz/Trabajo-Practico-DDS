...
export default function AerolineasRegistro({
  AccionABMC,
  Item,
  Grabar,
  Volver,
  ...
  useEffect(() => {
    if (Item) {
      ...
      setValue("pais_origen", Item.pais_origen || "");
    }
  }, [Item, setValue]);
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="container-fluid">
        <fieldset disabled={AccionABMC === "C"}>
          ...
          <div className="row">
            <div className="col-sm-4 col-md-3 offset-md-1">
              <label className="col-form-label" htmlFor="pais_origen">
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                className={
                  "form-control" + (errors?.pais_origen ? " is-invalid" : "")
                }
              />
              {errors?.pais_origen && (
                <div className="invalid-feedback">
                  {errors?.pais_origen?.message}
                </div>
              )}
            </div>
          </div>
